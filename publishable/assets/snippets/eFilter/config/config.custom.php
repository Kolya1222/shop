            ...
            <aside class="filter-sidebar">
                <form id="eFiltr" class="eFiltr eFiltr_form" action="[+url+]" method="[+form_method+]">
                    <div class="filter-header">
                        <h3>Фильтры</h3>
                        <span class="filter-clear"><a href="[+url+]" style="text-decoration: none;color: var(--fresh-green);">Очистить все</a></span>
                    </div>
                    <div style="display:none;" id="eFiltr_info"><span id="eFiltr_info_cnt">[+cnt+]</span><span id="eFiltr_info_cnt_ending">[+ending+]</span></div>
                    [+wrapper+]
                    <div class="eFiltr_form_result" style="display:none;">[+form_result_cnt+]</div>
                    <div class="eFiltr_btn_wrapper"><input type="submit" class="eFiltr_btn filter-apply-btn" value="[+btn_text+]"></div>
                </form>
            </aside>';
...
$tplRowCheckbox = '
    <label class="filter-option [+disabled+]">
        <input type="checkbox" name="f[[+tv_id+]][]" value="[+value+]" [+selected+] [+disabled+]> [+name+] <span class="count fltr_count">[+count+]</span>
    </label>
';
$tplOuterCheckbox = '
    <div class="fltr_block fltr_block_checkbox fltr_block[+tv_id+] [+active_block_class+]" data-tv-name="[+tv_name+]">
        <span class="filter-section-title fltr_name fltr_name_checkbox fltr_name[+tv_id+]">[+name+]</span>
        [+wrapper+]
    </div>
';
...
$tplOuterSelect = '
    <div class="catalog-sort fltr_block fltr_block_select fltr_block[+tv_id+] [+active_block_class+]" data-tv-name="[+tv_name+]">
        <span class="filter-section-title fltr_name fltr_name_select fltr_name[+tv_id+]">[+name+]</span>
        <select class="filter-select" name="f[[+tv_id+]][]">
...
//диапазон
$tplRowInterval = '<input class="filter-range-input" type="number" name="f[[+tv_id+]][min]" value="[+minval+]" data-min-val="[+minvalcurr+]"> <input class="filter-range-input" type="number" name="f[[+tv_id+]][max]" value="[+maxval+]" data-max-val="[+maxvalcurr+]">';
$tplOuterInterval = '
    <div class="filter-section fltr_block fltr_block_interval fltr_block[+tv_id+] [+active_block_class+]" data-tv-name="[+tv_name+]">
        <div class="filter-section-title fltr_name fltr_name_interval fltr_name[+tv_id+]">[+name+]</div>
...
$tplRowRadio = '
    <label class="filter-option">
        <input type="radio" name="f[[+tv_id+]][]" value="[+value+]" [+selected+] [+disabled+]> [+name+] <span class="fltr_count">[+count+]</span>
    </label>';
$tplOuterRadio = '
    <div class="filter-section fltr_block fltr_block_radio fltr_block[+tv_id+] [+active_block_class+]" data-tv-name="[+tv_name+]">
        <div class="filter-section-title fltr_name fltr_name_radio fltr_name[+tv_id+]">[+name+]</div>
        [+wrapper+]
    </div>
';
